...
(async () => {
        ...
        },
        {
            ...
            instructions: [
                {
                    extractionInstructions: {
                        ...
                        title: { extractType: "text", selector: ".job-card__title" },
                        location: { extractType: "text", selector: ".job-card__meta-item" },
                        remoteOrHybrid: { extractType: "", selector: "" },
                        datePosted: { extractType: "text", selector: ".job-card__age" },
            ...
            steps: [
                ...
                },
                {
                    order: 2,
                    action: "clickEvaluate",
                    selector: "xpath///button/span[text()='Worldwide']",
                    selectOption: "",
                    url: null,
                },
                {
    ...
    for (const company of companies) {
        ...
        try {
            ...
            console.error(`Failed to create company: ${company.name} due to error: ${error}`);
        }
    }
})();
